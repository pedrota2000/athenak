...
run_dir=/mnt/ceph/users/ptarancon/runs/turb_512_viscous_run_$(date +%Y%m%d_%H%M%S)
mkdir -p $run_dir
cd $run_dir

# Copy input file
cp $athenak/inputs/custom_tests/3d_turb_viscous.athinput ./input.athinput
